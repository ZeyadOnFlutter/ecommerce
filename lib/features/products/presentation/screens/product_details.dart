...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<SpecificProductCubit, ProductStates>(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        ProductCounter(
                          initialValue: _productQuantityCubit.productQuantity,
                          onIncrement:
                              _productQuantityCubit.changeProductQuantity,
                          onDecrement:
                              _productQuantityCubit.changeProductQuantity,
                        ),
                      ],
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            BlocBuilder<ProductQuantityCubit, ProductStates>(
                              builder: (context, productstate) {
                                return Text(
                                  'EGP ${(specificproductstate.specificProduct.priceAfterDiscount ?? specificproductstate.specificProduct.price) * _productQuantityCubit.productQuantity}',
                                  style: getMediumStyle(
